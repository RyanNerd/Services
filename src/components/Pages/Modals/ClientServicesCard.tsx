...
interface IProps {
    ...
    dateOfService: Date; // todo: build out services checkbox list per this date
...
const ClientServicesCard = (props: IProps) => {
    ...
    useEffect(() => {
        if (serviceLogList && props.serviceLogUpdated) {
            props.serviceLogUpdated();
        }
    }, [props, serviceLogList]);
